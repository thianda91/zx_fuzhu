...
<body>
    <div class="echo">
       <span style="color:red;"><?php $ip = request()->ip(); echo 'Your ip: '.$ip.', is recorded by us. PLEASE DO NOT ATTACK!';echo $echo;?></span>
    </div>
	...
	<?php
		$isSafeLocation = substr($ip,0,8)=='10.61.21' || $ip=='0.0.0.0' || $ip=='127.0.0.1';
		if($isSafeLocation){
	?>
    <?php if(!empty($tables)){ ?>
    <div class="exception-var">
